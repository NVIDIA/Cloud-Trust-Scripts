...
gcloud projects add-iam-policy-binding ${PROJECT_ID} --member=serviceAccount:nvidia-cloud-trust@nv-cloudtrust-prod.iam.gserviceaccount.com --role=roles/iam.serviceAccountTokenCreator
...
gcloud iam service-accounts add-iam-policy-binding "${SERVICE_ACCOUNT_NAME}@${PROJECT_ID}.iam.gserviceaccount.com" --member=serviceAccount:nvidia-cloud-trust@nv-cloudtrust-prod.iam.gserviceaccount.com --role=roles/iam.serviceAccountTokenCreator --project $1

gcloud projects add-iam-policy-binding ${PROJECT_ID} --member="serviceAccount:${SERVICE_ACCOUNT_NAME}@${PROJECT_ID}.iam.gserviceaccount.com"  --role=roles/storage.objectViewer
