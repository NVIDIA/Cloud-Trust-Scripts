...
gcloud projects add-iam-policy-binding $1 --member=serviceAccount:nvidia-cloud-trust@nv-cloudtrust-prod.iam.gserviceaccount.com --role=roles/iam.serviceAccountTokenCreator
...
gcloud iam service-accounts add-iam-policy-binding "$2@$1.iam.gserviceaccount.com" --member=serviceAccount:nvidia-cloud-trust@nv-cloudtrust-prod.iam.gserviceaccount.com --role=roles/iam.serviceAccountTokenCreator --project $1
